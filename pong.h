    ...
    public nc::IInputEventHandler
{
  ...
  private:
	...
	//TODO:
	gm::GameStateStatic gameStatic;
	gm::GameStateDynamic gameDynamic;
	ai::AStar ai;
	...
	//TODO: why is a memory leak handled in here but not in the program ?? 
	nctl::UniquePtr<nc::TextNode> testText_;
